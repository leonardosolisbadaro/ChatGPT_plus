        ...
        v = (function () {
          ...
          return (
            ...
            (e.getConversations = function (e, t, n) {
              console.log('getConversations', e, t, n); // info
              debugger; // debug
              var o =
                  arguments.length > 3 &&
                  void 0 !== arguments[3] &&
            ...
            (e.getConversation = function (e, t) {
              console.log('getConversation', e, t); // info
              debugger; // debug
              return this.fetch(
            ...
            (e.generateTitle = function (e, t, n) {
              console.log('generateTitle', e, t, n); // info
              debugger; // debug
              return this.fetch(
            ...
            (e.publicApiCompletionStream = function (e, t) {
              console.log('publicApiCompletionStream', e, t); // info
              debugger; // debug
              var n = this;
              return (0, o.Z)(function () {
                var r, s, c, d;
            ...
            (e.runModerationApi = function (e, t, n) {
              console.log('runModerationApi', e, t, n); // info
              debugger; // debug
              return this.fetch(
                ''.concat(
                  'https://chat.openai.com/backend-api',
            ...
            (e.getPluginByDomain = function (e) {
              console.log('getPluginByDomain', e); // info
              debugger; // debug
              var t = e.domain,
                n = e.accessToken,
            ...
            (e.createOrUpdateLocalhostPlugin = function (e) {
              console.log('createOrUpdateLocalhostPlugin', e); // info
              debugger; // debug
              var t = e.localhost,
                n = e.manifest,
                o = e.openapiSpec,
            ...
            (e.scrapePluginManifest = function (e) {
              console.log('scrapePluginManifest', e); // info
              debugger; // debug
              var t = e.domain,
            ...
            (e.getPluginApi = function (e) {
              console.log('getPluginApi', e); // info
              debugger; // debug
              var t = e.id,
                n = e.accessToken;
            ...
            (e.updatePluginUserSettings = function (e) {
              console.log('updatePluginUserSettings', e); // info
              debugger; // debug
              var t = e.pluginId,
                n = e.isInstalled,
                o = e.accessToken;
            ...
            (e.getAccountStatus = function (e, t) {
              console.log('getAccountStatus', e, t); // info
              debugger; // debug
              var n = (0, i.Z)(
                { 'Content-Type': 'application/json' },
                this.getAuthHeader(e),
