  ...
  [264],
  {
    ...
    33264: function (e, t, n) {
      ...
      var p = n(34388),
        l = n(49674),
        f = n(11938),
        g = 'https://chat.openai.com/backend-api',
        m = ['cf-ipcountry'],
        v = (function () {
          function e() {
            (0, r.Z)(this, e);
          ...
          return (
            ...
            (e.getAuthHeader = function (e) {
              ...
              return { Authorization: 'Bearer '.concat(t) };
            }),
            (e.refreshApiKey = function () {
              ...
              var t = this;
              return (
                (this.apiKeyRefreshing = (0, o.Z)(function () {
                  var e;
                  return (0, h.__generator)(this, function (n) {
                    switch (n.label) {
                      case 0:
                        return [4, (0, d.getSession)()];
                      case 1:
                        return (
            ...
            (e.fetch = function (e, t) {
              ...
              return (0, o.Z)(function () {
                var o, a, c, u, d, p;
                return (0, h.__generator)(this, function (h) {
                  switch (h.label) {
                    case 0:
                      return [
                        4,
                        fetch(e, (o = (0, i.Z)({ credentials: 'include' }, t))),
                      ];
                    case 1:
                      if ((a = h.sent()).status >= 500)
                        throw (
                          (n.intercomEventOnError &&
                            (0, f.LJ)(n.intercomEventOnError, {
                              url: e,
                              status: a.status.toString(),
                            }),
                          new l.kb())
                        );
                      if (!(a.status >= 400)) return [3, 12];
                      h.label = 2;
                    case 2:
                      return h.trys.push([2, 4, , 5]), [4, a.json()];
                    case 3:
                      return (
                        (c =
                          (null == (u = h.sent()) ? void 0 : u.detail) ||
                    ...
                    case 5:
                      if (
                        (console.error('API error', e, c),
                        !(
                          (null == c ? void 0 : c.code) ===
                            'expired_session_key' ||
                          (null == c ? void 0 : c.code) === 'token_expired'
                        ))
                      )
                        return [3, 11];
                      h.label = 6;
                    case 6:
                      if ((h.trys.push([6, 9, , 10]), n.isRetry)) return [3, 8];
                    ...
                    case 9:
                      return (
                        (p = h.sent()),
                        console.error(
                          'Failed to refresh expired access token: '.concat(p),
                        ),
                        [3, 10]
                      );
                    case 10:
            ...
            (e.createArtifact = function (e) {
              console.log('createArtifact...', e); // mod
              return this.fetch(''.concat(g, '/artifacts'), {
                method: 'POST',
                headers: (0, i.Z)(
                  { 'Content-Type': 'application/json' },
            ...
            (e.upload = function (e, t, n, o) {
              console.log('upload...', e, t, n, o); // mod
              var r = new FormData();
              return (
                ...
                this.fetch(''.concat(g, '/conversation/upload'), {
                  method: 'POST',
                  headers: (0, i.Z)({}, this.getAuthHeader()),
                  body: r,
                })
              );
            }),
            (e.fetchFileForDownload = function (e, t) {
              var n = new URLSearchParams({ path: t });
              return fetch(
                ''
                  .concat(g, '/conversation/')
                  .concat(e, '/download?')
                  .concat(n),
                { method: 'GET', headers: (0, i.Z)({}, this.getAuthHeader()) },
              );
            }),
            (e.checkFile = function (e, t) {
              console.log('checkFile...', e, t); // mod
              var n = new URLSearchParams({ path: t });
              return this.fetch(
                ''
                  .concat(g, '/conversation/')
            ...
            (e.getRetrievalResults = function (e) {
              console.log('getRetrievalResults...', e); // mod
            ...
            (e.getConversations = function (e, t, n) {
              console.log('getConversations...', 'e', 't', 'n'); // mod
              var o =
                  arguments.length > 3 &&
                  void 0 !== arguments[3] &&
                  arguments[3],
              ...
              return (
                o && r.set('order', 'updated'),
                this.fetch(
                  ''.concat(g, '/conversations?').concat(r),
                  {
                    method: 'GET',
                    headers: (0, i.Z)(
                      { 'Content-Type': 'application/json' },
            ...
            (e.getConversation = function (e, t) {
              console.log('getConversation...', 'e', t); // mod
              return this.fetch(
                ''.concat(g, '/conversation/').concat(e),
                {
                  method: 'GET',
                  headers: (0, i.Z)(
                    { 'Content-Type': 'application/json' },
            ...
            (e.generateTitle = function (e, t, n) {
              return this.fetch(
                ''.concat(g, '/conversation/gen_title/').concat(e),
                {
                  method: 'POST',
                  headers: (0, i.Z)(
                    { 'Content-Type': 'application/json' },
                  ...
                  body: JSON.stringify({ message_id: t }),
                },
                {
            ...
            (e.patchConversation = function (e, t) {
              console.log('patchConversation...', e, t); // mod
              return this.fetch(
                ''.concat(g, '/conversation/').concat(e),
                {
                  method: 'PATCH',
            ...
            (e.deleteConversations = function () {
              console.log('deleteConversations...'); // mod
              return this.fetch(
                ''.concat(g, '/conversations'),
                {
                  method: 'PATCH',
                  headers: (0, i.Z)(
                    { 'Content-Type': 'application/json' },
            ...
            (e.getLoginLink = function (e) {
              console.log('getLoginLink...', e); // mod
            ...
            (e.publicApiCompletionStream = function (e, t) {
              // mod
              console.log('publicApiCompletionStream...', e, 't');
              // e.enabledPluginIds = [
              //   'p1ugin-6ea51ff4-f379-46b5-b9b7-2fdf47064475',
              // ]; // void 0;
              debugger;
              // eomod
              var n = this;
              return (0, o.Z)(function () {
                var r, s, c, d;
                return (0, h.__generator)(this, function (d) {
                  return (
                    ...
                    (0, u.L)(c, {
                      ...
                      onmessage: function (e) {
                        if ('[DONE]' === e.data)
                          r.abort(), t({ finish_reason: 'stop' });
                        else if ('ping' === e.event);
                        else
                          try {
                            var n = JSON.parse(e.data);
                            if (n.error) throw new l.kb(n.error.message);
                            t({
                              message: n.message,
                      ...
                      onerror: function (e) {
                        throw (
                          ...
                          (0, f.LJ)('fetch-error:conversation:new-message', {
                            url: c,
            ...
            (e.runModerationApi = function (e, t, n) {
              console.log('runModerationApi...', e); // mod
              return this.fetch(
                ''.concat(
                  'https://chat.openai.com/backend-api',
                  '/moderations',
            ...
            (e.submitMessageFeedback = function (e) {
              console.log('submitMessageFeedback...', e); // mod
              return this.fetch(
                ''.concat(g, '/conversation/message_feedback'),
                {
                  method: 'POST',
                  headers: (0, i.Z)(
                    { 'Content-Type': 'application/json' },
            ...
            (e.submitMessageComparisonFeedback = function (e) {
              console.log('submitMessageComparisonFeedback...', e); // mod
              return this.fetch(
                ''.concat(g, '/conversation/message_comparison_feedback'),
                {
                  method: 'POST',
                  headers: (0, i.Z)(
                    { 'Content-Type': 'application/json' },
            ...
            (e.getCheckoutLink = function () {
              console.log('getCheckoutLink...'); // mod
            ...
            (e.fetchCustomerPortalUrl = function (e) {
              console.log('fetchCustomerPortalUrl...', e); // mod
              return this.fetch(
                ''.concat(g, '/payments/customer_portal'),
                {
                  method: 'GET',
                  headers: (0, i.Z)(
                    { 'Content-Type': 'application/json' },
            ...
            (e.getPluginByDomain = function (e) {
              console.log('getPluginByDomain...', e); // mod
              var t = e.domain,
                n = e.accessToken,
                o = new URLSearchParams({ domain: t });
            ...
            (e.createOrUpdateLocalhostPlugin = function (e) {
              console.log('createOrUpdateLocalhostPlugin...', e); // mod
              var t = e.localhost,
                n = e.manifest,
                o = e.openapiSpec,
                r = e.accessToken;
            ...
            (e.scrapePluginManifest = function (e) {
              console.log('scrapePluginManifest...', e); // mod
              var t = e.domain,
              ...
              return this.fetch(''.concat(g, '/aip/p'), {
                ...
                body: JSON.stringify({ domain: t, manifest_access_token: n }),
              });
            }),
            (e.getPluginApi = function (e) {
              console.log('getPluginApi...', e); // mod
              var t = e.id,
                n = e.accessToken;
            ...
            (e.updatePluginUserSettings = function (e) {
              console.log('updatePluginUserSettings...', e); // mod
              var t = e.pluginId,
                n = e.isInstalled,
                o = e.accessToken;
              return this.fetch(
                ''.concat(g, '/aip/p/').concat(t, '/user-settings'),
                {
                  method: 'PATCH',
                  headers: (0, i.Z)(
                    { 'Content-Type': 'application/json' },
                  ...
                  body: JSON.stringify({ is_installed: n }),
                },
              );
            }),
            (e.deletePlugin = function (e) {
              console.log('deletePlugin...', e); // mod
              var t = e.id,
                n = e.accessToken;
            ...
            (e.setPluginUserHttpToken = function (e) {
              console.log('setPluginUserHttpToken...', e); // mod
              var t = e.id,
                n = e.userAccessToken,
                o = e.accessToken;
              return this.fetch(
                ''.concat(g, '/aip/p/').concat(t, '/user-settings/http-auth'),
                {
                  method: 'POST',
                  headers: (0, i.Z)(
                    { 'Content-Type': 'application/json' },
                  ...
                  body: JSON.stringify({ access_token: n }),
                },
              );
            }),
            (e.setPluginServiceHttpToken = function (e) {
              console.log('setPluginServiceHttpToken...', e); // mod
              var t = e.id,
                n = e.serviceAccessToken,
                o = e.accessToken;
              return this.fetch(
                ''.concat(g, '/aip/p/').concat(t, '/http-auth'),
                {
                  method: 'POST',
                  headers: (0, i.Z)(
                    { 'Content-Type': 'application/json' },
            ...
            (e.setPluginOAuthClientCredentials = function (e) {
              console.log('setPluginOAuthClientCredentials...', e); // mod
              var t = e.id,
                n = e.clientId,
                o = e.clientSecret,
                r = e.accessToken;
            ...
            (e.getAccountStatus = function (e, t) {
              console.log('getAccountStatus...', 'e', t); // mod
              var n = (0, i.Z)(
                { 'Content-Type': 'application/json' },
                this.getAuthHeader(e),
              );
              if (t) {
                ...
                try {
                  for (
                    var h, u = Object.entries(t)[Symbol.iterator]();
                    !(r = (h = u.next()).done);
                    r = !0
                  ) {
                    var d = (0, c.Z)(h.value, 2),
                      p = d[0],
                      l = d[1];
            ...
            (e.submitDataExport = function (e) {
              console.log('submitDataExport...', e); // mod
            ...
            (e.pluginOauthCallback = function (e, t, n, o) {
              console.log('pluginOauthCallback...', e, t, n, o); // mod
              var r = new URLSearchParams({ code: t, redirect_uri: n });
              return this.fetch(
                ''
                  .concat(g, '/aip/p/')
                  .concat(e, '/user-settings/oauth/callback?')
                  .concat(r),
                {
                  method: 'GET',
                  headers: (0, i.Z)(
            ...
            (e.getPageMetadata = function (e) {
              console.log('getPageMetadata...', e); // mod
              var t = e.url;
              return this.fetch(
                ''
                  .concat(g, '/opengraph/tags?url=')
            ...
            (e.getModelMessageCap = function () {
              console.log('getModelMessageCap...'); // mod
              return this.fetch(
                'https://chat.openai.com/public-api/conversation_limit',
                {
                  method: 'GET',
                  headers: (0, i.Z)(
                    { 'Content-Type': 'application/json' },
      ...
      function i(e, t) {
        ...
        e.id &&
          ...
          n('boot', {
            ...
            is_chatgpt_user: !0,
            paid_chatgpt_subscriber:
              null == t ? void 0 : t.is_paid_subscription_active,
            paid_chatgpt_active_until:
              null == t ? void 0 : t.subscription_expires_at_timestamp,
          });
      }
      function s(e, t) {
        var n = window.Intercom;
